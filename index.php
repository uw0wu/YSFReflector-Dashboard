...
?>
  ...
  <head>
    ...
    <title>
      <?php echo getConfigItem("Info", "Name", $configs); ?> - YSFReflector-Dashboard by DG9VH</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">YSFReflector #82255 - Dashboard by DG9VH for Reflector: <?php echo getConfigItem("Info", "Name", $configs); ?> / <?php echo getConfigItem("Info", "Description", $configs); ?></a>
      </span>
        <span class="navbar-brand float:right">
        YSFReflector #82255 by G4KLX Version: <?php  echo getYSFReflectorVersion(); ?>
      </span>
      </div>
    </nav>
        ...
        ?>
          ...
          <?php if (LOGO !== "") { ?>
            <div id="Logo" class="col-2">
              <img src="<?php echo LOGO ?>" width="185" style="width:185px; border-radius:10px;box-shadow:2px 2px 2px #808080; padding:1px;background:#FFFFFF;border:1px solid #808080;" border="0" hspace="50" vspace="10" align="justify-content-center">
            </div>
            <?php } else { ?>
              <div id="Logo" class="col-2">
